    ...
    <div class="container" style="position: relative; z-index: 2; animation: slideInUp 0.8s ease-out;">
      <div style="max-width: 800px;">
        <div style="display: inline-block; padding: var(--space-1) var(--space-3); background: rgba(255, 255, 255, 0.15); border-radius: var(--radius-full); margin-bottom: var(--space-4); font-size: var(--font-size-small); font-weight: 700; letter-spacing: 0.5px;">
          <i class="fa-solid fa-images" aria-hidden="true"></i> PHOTO COLLECTIONS
        </div>
    ...
    <div class="container">
      ...
      if ( $galleries->have_posts() ) {
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(min(100%, 350px), 1fr)); gap: var(--space-8);">
          ...
          while ( $galleries->have_posts() ) {
            ...
            <a href="<?php the_permalink(); ?>" style="text-decoration: none; color: inherit;">
              <div class="gallery-card" style="background: var(--color-white); border-radius: var(--radius-xl); overflow: hidden; box-shadow: var(--shadow-md); transition: all var(--transition-base); display: flex; flex-direction: column; height: 100%; opacity: 0; transform: translateY(30px); animation: slideInUp 0.6s ease-out forwards; animation-delay: <?php echo esc_attr( $delay ); ?>s;">

                <!-- Gallery Thumbnail -->
                <div style="position: relative; height: 280px; overflow: hidden; background: linear-gradient(135deg, var(--color-primary-700), var(--color-primary-400));">
                  <?php
                  if ( $first_image_id ) {
                  ...
                  <div style="position: absolute; inset: 0; background: rgba(0, 0, 0, 0); display: flex; align-items: center; justify-content: center; opacity: 0; transition: all var(--transition-base); pointer-events: none;">
                    <span style="color: var(--color-white); font-size: 3rem; font-weight: bold;"><i class="fa-solid fa-eye" aria-hidden="true"></i></span>
                  </div>
                </div>
                ...
                <div style="padding: var(--space-6); flex: 1; display: flex; flex-direction: column;">
                  ...
                  <div style="margin-top: auto; padding-top: var(--space-4); border-top: 1px solid var(--color-gray-100);">
                    <span style="color: var(--color-accent-dark); font-weight: 700; display: inline-flex; align-items: center; gap: var(--space-2); transition: all var(--transition-fast); font-size: var(--font-size-small);">
        ...
        <div style="text-align: center; padding: var(--space-20); background: var(--color-white); border-radius: var(--radius-xl); animation: slideInUp 0.8s ease-out;">
          <div style="font-size: 4rem; margin-bottom: var(--space-4); animation: float 3s ease-in-out infinite;"><i class="fa-solid fa-images" aria-hidden="true"></i></div>
